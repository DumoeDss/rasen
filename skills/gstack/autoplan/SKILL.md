...
echo "RESTORE_PATH=$HOME/.openspec/projects/$SLUG/${BRANCH}-autoplan-restore-${DATETIME}.md"
```
...
- Discover design docs: `ls -t ~/.openspec/projects/$SLUG/*-design-*.md 2>/dev/null | head -1`
...
- `~/.openspec/skills/plan-ceo-review/SKILL.md`
- `~/.openspec/skills/plan-design-review/SKILL.md` (only if UI scope detected)
- `~/.openspec/skills/plan-eng-review/SKILL.md`
...
- Test plan: generate artifact at `~/.openspec/projects/$SLUG/{user}-{branch}-test-plan-{datetime}.md`
...
- [ ] Test plan artifact written to disk at ~/.openspec/projects/$SLUG/
- [ ] "NOT in scope" section written
- [ ] "What already exists" section written
