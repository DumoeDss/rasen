...
## Purpose
Include the browse headless Chromium browser CLI as part of the OpenSpec package, enabling skills that require browser functionality to use it directly.
