...
## Purpose
Provide the `/opsx:auto` autopilot command — task-complexity classification, pipeline selection (full-feature / small-feature / bug-fix), gated pause points, expert selection, and DAG-state resume — driving the OPSX workflow end-to-end.
## Requirements
