# gen-skill-docs-path-migration Specification

## Purpose
Generate skill docs using OpenSpec paths and variables (`~/.openspec/`) for the Claude and Codex hosts, keeping regenerated SKILL.md files consistent.
