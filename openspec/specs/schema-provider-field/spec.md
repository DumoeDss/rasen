...
## Purpose
Add a schema `provider` field — provider artifacts in the DAG, instruction output, skill resolution, and state detection — with backward-compatible validation and JSON output.
