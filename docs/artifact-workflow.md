...
This is now the standard workflow for rasen — we call it **the artifact workflow**.
...
**The artifact workflow opens it up.** Now anyone can:
...
We're all still learning what works best. The artifact workflow lets us learn together.
...
**The artifact workflow's approach:**
...
| | Legacy (`/openspec:proposal`) | Artifact workflow (`/rasen-*`) |
|---|---|---|
...
**The key insight:** work isn't linear. The artifact workflow stops pretending it is.

## Architecture Deep Dive

This section explains how the artifact workflow works under the hood and how it compares to the legacy workflow.
...
**The artifact workflow** uses external schemas and a dependency graph engine:
...
**The artifact workflow** — agent queries for rich context:
...
**The artifact workflow** — natural iteration:
