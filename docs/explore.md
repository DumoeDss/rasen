...
If you use the expanded command set, explore can hand off to `/rasen:new` instead, for step-by-step artifact creation. See [Workflows](workflows.md).
...
- **Explore again mid-change.** Stuck during `/rasen:apply`? You can step back and explore a sub-problem, then return.
