...
It's the gentlest possible introduction on a real project, and it leaves you with a genuine (small) change you can keep or discard. See [Commands: `/rasen:onboard`](commands.md#opsxonboard).
