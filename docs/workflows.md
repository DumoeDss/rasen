...
Each review pass delegates to the `rasen-review` engine, installed with review-cycle through skill dependency closure even when not selected directly — the loop does not reimplement review heuristics. It adds four things on top:
