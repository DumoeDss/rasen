...
#### Scenario: Unbound project space addressed by id
...
#### Scenario: Store space is aggregate
...
#### Scenario: Unhealthy or inconsistent space
...
#### Scenario: Worktree root path resolves to the owning project scope
...
#### Scenario: Configuration-only pointer project stays standalone
...
#### Scenario: Unbound launch project preserves existing behavior
