...
- [ ] 9.11 Full suite green: `pnpm lint`, `pnpm build`, `pnpm test`. — lint/build green and every targeted suite green; the FULL run is the LEAD's, per this child's instructions.
