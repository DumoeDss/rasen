...
> This new capability takes over the pipelines endpoint contract from `config-http-api` (see that spec's REMOVED delta in this change) and extends it; the mutation bridge mirrors the workflow-http-api pattern.
