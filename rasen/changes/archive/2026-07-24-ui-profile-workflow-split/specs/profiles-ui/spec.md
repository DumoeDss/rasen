# profiles-ui Delta Specification

## Purpose

Give named workflow profiles their own management page in the UI: browse built-in and saved profiles, create and delete them, and edit a saved profile's workflow membership with the same sectioned card presentation the Workflows page uses — managing the *list*, never installing or uninstalling anything.
