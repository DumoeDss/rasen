...
- FROM: `### Requirement: Expert skill names use gstack: prefix`
- TO: `### Requirement: Expert skill names use openspec: prefix`

- FROM: `### Requirement: Expert skill dirNames use openspec-gstack- prefix`
- TO: `### Requirement: Expert skill dirNames use openspec- prefix`
