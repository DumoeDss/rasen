...
- [ ] 4.3 Verify the focused matrix on Windows CI and a POSIX CI job, recording the exact directory-open/sync outcomes and exact large identity evidence without weakening the lookup table to accommodate unrelated failures.
