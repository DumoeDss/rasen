...
#### Scenario: Each methodology has a host-owned entry reference
...
#### Scenario: Grill vocabulary preserved after installation
...
#### Scenario: Installed references carry the NOTICE
...
#### Scenario: Expert catalog documents the surviving roster
