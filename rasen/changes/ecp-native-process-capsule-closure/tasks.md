...
- [ ] 12.6 Close `RC-003`: remove controller-live/group-empty false closure and prove only the platform authority can issue `scope-empty`. **Leaves with the parked crates** (upgrade-path; POSIX one-shot path additionally not constructed); no 0.2.0 work.
