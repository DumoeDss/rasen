...
## Purpose
Parse spec scenarios into an exported TestPlan structure — scenario extraction, incomplete-scenario handling, and multi-file aggregation — for context-from integration.
