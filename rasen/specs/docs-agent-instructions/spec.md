...
- **WHEN** `rasen/AGENTS.md` is regenerated or updated
...
`rasen/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`rasen/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `rasen validate`.
...
- **WHEN** reorganizing `rasen/AGENTS.md`
...
- **WHEN** `rasen/AGENTS.md` explains how to write `spec.md`
