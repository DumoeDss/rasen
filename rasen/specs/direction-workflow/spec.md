# direction-workflow Specification

## Purpose

Defines the optional, long-lived Direction workflow that governs cross-Change workstreams without becoming a prerequisite for ordinary Rasen work.
