...
## Purpose
Adapt Rasen for the Hermes (Nous Research `hermes` CLI) agent: offer it as an adapted install target, and install its workflow skills to Hermes's global skills home rather than a project-local directory.
## Requirements
