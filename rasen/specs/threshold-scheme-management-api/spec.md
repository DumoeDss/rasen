# threshold-scheme-management-api Specification

## Purpose

Provide the loopback-secured management surface for inspecting and mutating machine-level threshold schemes, preset seeds, and runtime binding vocabulary while keeping the root and web UI wire contracts synchronized.
