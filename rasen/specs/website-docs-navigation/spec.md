...
## Purpose
Define reader-facing navigation for the rendered docs section of the rasen website: manifest-driven sidebar, docs index, prev/next reading order, and CRT-consistent document typography.
