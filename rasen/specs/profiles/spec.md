...
## Purpose
Define installation profiles (with a delivery dimension independent of profile), selectable via an interactive picker, stored in global config, and applied through the update command.
