# project-record-read-integrity Specification

## Purpose
Authority reads of project records distinguish absent (ENOENT) from unreadable (EACCES, I/O fault, delete-pending). Only a truly missing record is treated as absent; unreadable records surface a degraded diagnostic rather than silently masquerading as non-members.
## Requirements
