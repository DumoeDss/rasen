# remove-gstack-features Specification

## Purpose
Remove deprecated gstack-only generation features — upgrade check, lake intro, contributor mode, session tracking, and global-discover references.
