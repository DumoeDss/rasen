# session-audit-ui Specification

## Purpose

Provide an installation-wide Web UI for discovering sessions, running or importing audits, browsing saved analytics, and rendering audit reports in a width-prioritized workspace.
