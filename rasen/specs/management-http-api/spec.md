...
#### Scenario: Missing or invalid session credential

- **WHEN** a client sends any protected `/api/v1/*` request without a valid bearer token or browser-session cookie
