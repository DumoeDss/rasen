...
**Store finalization hard gate:** inspect the first resolved CLI payload before any planning, Git, spec, or filesystem mutation. If root.scope.kind is 'store-project', REFUSE with 'store_v2_finalization_unavailable' and do not save or apply an Archive plan; its typed Archive/spec paths are read-only locators. Any other scope, including 'legacy-store', proceeds normally.
