...
- **Don't implement** - Never write code or implement features. Creating Rasen artifacts is fine, writing application code is not. The single exception is the bounded throwaway branch described by \`references/prototype/README.md\` (see "Prototype to Settle a Stuck Question") — its code MUST be deleted once the answer is captured.
