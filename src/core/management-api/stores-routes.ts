/**
 * [L7 port] The 0.1.7 Store route family (path-scoped by store uid), kept as a
 * separate module so this line's flat-path store handlers (stores.ts) and the
 * ECP router surface stay untouched. Dispatched by router.ts before the legacy
 * flat paths.
 *
