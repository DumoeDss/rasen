...
function getWelcomeText(): string[] {
  return [
    ...
    chalk.dim('  • /rasen:* slash commands'),
    '',
    chalk.white('Quick start after setup:'),
    `  ${chalk.yellow('/rasen:new')}      ${chalk.dim('Create a change')}`,
    `  ${chalk.yellow('/rasen:continue')} ${chalk.dim('Next artifact')}`,
    `  ${chalk.yellow('/rasen:apply')}    ${chalk.dim('Implement tasks')}`,
    '',
