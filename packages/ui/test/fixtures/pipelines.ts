      ...
      stages: [
        {
          ...
          effectiveEffort: { value: 'high', source: 'project-role' },
        ...
        },
        {
          ...
          effectiveEffort: { value: 'max', source: 'stage-override-project' },
          effectiveHandoff: {
        ...
        },
        {
          ...
          effectiveEffort: { value: null, source: 'default' },
          effectiveHandoff: { value: 0.5, source: 'default' },
          effectiveRuntime: { value: 'claude', source: 'default' },
        },
      ],
      ...
      stages: [
        {
          ...
          effectiveGate: { value: false, source: 'stage' },
          effectiveModel: { value: null, source: 'default' },
          effectiveEffort: { value: 'medium', source: 'global-default' },
          effectiveHandoff: { value: 0.5, source: 'default' },
          effectiveRuntime: { value: 'claude', source: 'default' },
        },
      ],
  ...
  entries: [
    ...
    },
    {
      definition: {
        ...
        type: 'string',
        defaultValue: undefined,
        description: 'Per-role model override for the implementer role',
        group: 'Workflow',
        constraints: { type: 'string' },
      },
      value: 'fable',
    ...
    },
    {
      definition: {
        ...
        type: 'string',
        defaultValue: undefined,
        description: 'Per-role model override for the fixer role',
        group: 'Workflow',
        constraints: { type: 'string' },
      },
      value: 'fable',
    ...
    },
    {
      definition: {
        ...
        type: 'string',
        defaultValue: undefined,
        description: 'Per-role model override for the shipper role',
        group: 'Workflow',
        constraints: { type: 'string' },
      },
      value: 'fable',
    ...
    },
    {
      definition: {
        ...
        defaultValue: undefined,
        description: 'Base reasoning effort for every leaf role',
        group: 'Workflow',
        constraints: { type: 'enum', enumValues: ['low', 'medium', 'high', 'xhigh', 'max'] },
      },
      value: 'medium',
      source: 'global',
    ...
    {
      definition: {
        key: 'efforts.roles.planner',
        scopes: ['global', 'store', 'project'],
        type: 'enum',
        enumValues: ['low', 'medium', 'high', 'xhigh', 'max'],
        defaultValue: undefined,
        description: 'Per-role reasoning effort override for the planner role',
        group: 'Workflow',
        constraints: { type: 'enum', enumValues: ['low', 'medium', 'high', 'xhigh', 'max'] },
      },
      value: undefined,
    ...
    {
      definition: {
        key: 'efforts.roles.implementer',
        scopes: ['global', 'store', 'project'],
        type: 'enum',
        enumValues: ['low', 'medium', 'high', 'xhigh', 'max'],
        defaultValue: undefined,
        description: 'Per-role reasoning effort override for the implementer role',
        group: 'Workflow',
        constraints: { type: 'enum', enumValues: ['low', 'medium', 'high', 'xhigh', 'max'] },
      },
      value: 'high',
      source: 'store',
      scopeValues: { store: 'high' },
    },
    {
      definition: {
        key: 'efforts.roles.reviewer',
        scopes: ['global', 'store', 'project'],
        type: 'enum',
        enumValues: ['low', 'medium', 'high', 'xhigh', 'max'],
        defaultValue: undefined,
        description: 'Per-role reasoning effort override for the reviewer role',
        group: 'Workflow',
        constraints: { type: 'enum', enumValues: ['low', 'medium', 'high', 'xhigh', 'max'] },
      },
      value: 'max',
    ...
    {
      definition: {
        key: 'efforts.roles.fixer',
        scopes: ['global', 'store', 'project'],
        type: 'enum',
        enumValues: ['low', 'medium', 'high', 'xhigh', 'max'],
        defaultValue: undefined,
        description: 'Per-role reasoning effort override for the fixer role',
        group: 'Workflow',
        constraints: { type: 'enum', enumValues: ['low', 'medium', 'high', 'xhigh', 'max'] },
      },
      value: undefined,
    ...
    {
      definition: {
        key: 'efforts.roles.shipper',
        scopes: ['global', 'store', 'project'],
        type: 'enum',
        enumValues: ['low', 'medium', 'high', 'xhigh', 'max'],
        defaultValue: undefined,
        description: 'Per-role reasoning effort override for the shipper role',
        group: 'Workflow',
        constraints: { type: 'enum', enumValues: ['low', 'medium', 'high', 'xhigh', 'max'] },
      },
      value: 'low',
    ...
    },
    {
      ...
      value: 'max',
      source: 'project',
      scopeValues: { global: 'low', project: 'max' },
      instanceKey: 'pipelines.small-feature.efforts.implement',
    },
    {
      definition: {
        key: 'pipelines.<name>.efforts.<stage>',
      ...
      source: 'global',
      scopeValues: { global: 'medium' },
      instanceKey: 'pipelines.small-feature.efforts.propose',
    },
    {
      definition: {
