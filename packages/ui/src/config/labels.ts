...
const LABEL_KEYS: Record<string, string> = {
  ...
  'keepalive.runtimes.claude': 'config.label.keepalive_runtime_claude',
  'keepalive.runtimes.codex': 'config.label.keepalive_runtime_codex',
  'keepalive.contextFloor': 'config.label.keepalive_context_floor',
