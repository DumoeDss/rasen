...
describe('FishGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      ...
      expect(script).toContain('# Fish completion script for Rasen CLI');
      expect(script).toContain('function __fish_rasen');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_rasen_using_subcommand');
      expect(script).toContain('function __fish_rasen_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c rasen");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_rasen_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_rasen_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_rasen_specs');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_rasen_schemas');
    ...
    it('should handle positional arguments for profile names', () => {
      ...
      expect(script).toContain('__fish_rasen_profiles');
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_rasen_changes');
      expect(script).toContain('rasen __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_rasen_specs');
      expect(script).toContain('rasen __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_rasen_items');
      expect(script).toContain('__fish_rasen_changes');
      expect(script).toContain('__fish_rasen_specs');
    });
