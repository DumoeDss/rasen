/**
 * openspec browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.openspec/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.openspec/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['openspec browse — headless browser for AI agents', '', 'Commands:'];
